...
jQuery(document).ready(function() {
    ...
    jQuery("ul#adminmenu li").hover(function(){
		jQuery(this).find("ul").stop().slideToggle(500);
	});
	
	jQuery("ul#adminmenu li").hover(function(){
		jQuery(this).find("ul").siblings().addClass("remove-border");
	});
	
	/*if (!jQuery('input[type="checkbox"]').parents('table').length){
		//
	} else {
